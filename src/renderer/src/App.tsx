...
import { BellRing, Check, CircleAlert, LoaderCircle, X } from 'lucide-react'
import type { AppState, Settings } from '../../shared/types'
import { ActivityBar, Help, Overview, ScheduleEditor, TempoLink } from './components'
...
export default function App() {
  ...
  return (
    <div className="app-shell">
      <ActivityBar help={help} onNavigate={setHelp} />
      <div className="workspace">
        <div className="title-bar">
          <span className="wordmark">Tempo Reminder</span>
        ...
        <main className="main-content">
          <header className="page-header">
            <div>
              ...
              <p>
                {help ? '你的下班搭子，使用起来就这么简单。' : '下班前，给今天的努力留个记录。'}
              </p>
            </div>
            {!help && draft ? (
                ...
                >
                  <footer className="form-footer">
                    ...
                    >
                      ...
                      开机启动
                      {!state.launchAtLoginSupported ? (
                        <span className="dev-only">安装版可用</span>
                      ) : null}
                    </label>
                    <span className="tray-note">关闭窗口后，继续在托盘守候。</span>
                    <div className="form-actions">
                      ...
                      <button className="button primary" type="submit" disabled={busy}>
                        ...
                        保存设置
                        {dirty ? <span className="unsaved-dot" title="有未保存的更改" /> : null}
                      </button>
                    </div>
                  </footer>
                </TempoLink>
